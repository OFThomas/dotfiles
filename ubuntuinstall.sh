...
sudo apt-get update
sudo apt-get install -y python-pip pandoc python-setuptools indicator-kdeconnect kdeconnect libsymengine-dev python-symengine vim-gtk okular texlive-full biber screenfetch
